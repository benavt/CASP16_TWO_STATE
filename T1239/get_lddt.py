...
def assessment(ID, score):
    ...
    plt.figure(figsize=(10, 6))
    plt.bar(combined_df['Group'], combined_df[f'best_v1_ref'], label=f'best_{score}_v1_ref')
    plt.bar(combined_df['Group'], combined_df[f'best_v2_ref'], bottom=combined_df[f'best_v1_ref'], label=f'best_{score}_v2_ref')
