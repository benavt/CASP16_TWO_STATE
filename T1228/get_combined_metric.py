...
plt.xlabel(f'Best Global_GDT V1A ref', fontsize=14)
plt.ylabel(f'Best Global_GDT V1B ref', fontsize=14)
plt.title(f'Scatter plot of best Global_GDT scores for 1228 V1A vs V1B', fontsize=16)
plt.legend()
plt.tight_layout()
# Save the plot as an image file
plt.savefig(f'1228_Global_GDT_scatter_plot.png')
# plt.show()
plt.cla()
...
# Save the plot as an image file
plt.savefig('T1228_combined_metric_plot.png')