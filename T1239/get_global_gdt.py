...
plt.title(f'Scatter plot of best Global_GDT scores for 1239 V1A vs V1B', fontsize=16, fontweight='bold')
plt.legend()
plt.tight_layout()
...
plt.bar(combined_df['Group'], combined_df['V1A_final_fit'], label='V1A GDT_TS', color='blue')
plt.bar(combined_df['Group'], combined_df['V1B_final_fit'], bottom=combined_df['V1A_final_fit'], label='V1B GDT_TS', color='orange')
plt.xlabel('Group', fontsize=14, fontweight='bold')
plt.ylabel('Two-State Score', fontsize=14, fontweight='bold')
plt.title('Aggregate Global GDT_TS scores for T1239 V1A and V1B', fontsize=16, fontweight='bold')
plt.legend()
